...
from fastapi import APIRouter, Body, HTTPException, satus
...
async def post(
    ...
    if not categoria:
        raise HTTPException(
            ...
            detail=f'O centro de treinamento {categoria_name} não foi encontrada'
        )
